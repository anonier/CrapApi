...
import cn.crap.dto.ViewMenuDto;
...
public class ModuleController extends BaseController {
    ...
    public JsonResult menu(@RequestParam String projectId) throws MyException {
        ...
        List<ViewMenuDto> result = new ArrayList<>();
        ...
        for (ModuleDTO dto : moduleDtoList) {
            ...
            ModulePO module = moduleService.get(dto.getId());
            InterfaceQuery query = new InterfaceQuery().setModuleId(dto.getId()).setInterfaceName(null).setFullUrl(null).setCurrentPage(null);
            Page page = new Page(query);
            ...
            ViewMenuDto menuDto = new ViewMenuDto() {
                {
                    setModuleDTO(dto);
        ...
        return new JsonResult(1, result, null, Tools.getMap("project", ProjectAdapter.getDTO(project, null)));
    }
}
