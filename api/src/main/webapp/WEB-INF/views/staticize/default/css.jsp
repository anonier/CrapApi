...
<style type="text/css">
    ...
    .s-nav-bg-color {
        background-color: ${settings.NAV_BG_COLOR} !important
    }
    ...
    .adorn-color {
        color: ${settings.ADORN_COLOR}
    }

    .adorn-bl-3 {
        border-left: 3px solid${settings.ADORN_COLOR}
    }

    .adorn-bb-1 {
        border-bottom: 1px solid${settings.ADORN_COLOR}
    }
    ...
    .bl-5 {
        border-left: 5px solid${settings.MAIN_COLOR}
    }
    ...
    .look-up-content {
        border-top: 3px solid${settings.MAIN_COLOR};
    }
    ...
    .login-bg {
        background: url('<%=settings.get("LOGINBG").startsWith("http")? settings.get("LOGINBG"):basePath + settings.get("LOGINBG")%>') 50% 50% / cover no-repeat fixed;
    }

    .title-bg-img {
        background-image: url('<%=settings.get("TITLEBG").startsWith("http")? settings.get("TITLEBG"):basePath + settings.get("TITLEBG")%>') !important;
