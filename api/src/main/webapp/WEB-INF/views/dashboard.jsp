    ...
    <div class="container p0">
        <div class="row p0 m0 CFFF">
            <div class="f30 tl fl col-xs-4 mt20">
                <a href="/opendoc" class="no_unl">
                    <i class="iconfont adorn-color f40">&#xe612;</i>
                    <span class="CFFF " style="font-family: Times New Roman">BOREDOU-API</span>
                </a>
            </div>
            ...
            <div class="cb"></div>
            <div class=" f30 mt100 tc fw200">API协作管理系统</div>
            ...
            <div class="tc mt50">
                <c:if test="${login}">
                    ...
                    <a class="btn btn-adorn r5 w150 f14 ml10 fw200" href="index.do#/project/list?projectShowType=3"
                       target="_blank">查看项目</a>
                </c:if>
                <c:if test="${login == false}">
                    <a class="btn btn-main r5 w150 f14 ml10 fw200" href="loginOrRegister.do#/login"
                       target="_blank">登录</a>
...
<div class="fun-introduce container p0 mt50">
    <div class="mt-15 bc BGFFF w400 f22 z10 rel tc adorn-color">在线管理平台</div>
    <c:forEach items="${menuList}" var="menuDto" varStatus="id">
            ...
            <div class="col-xs-3 tc h200 f20 mt10">
                <c:if test="${menuDto.menu.menuUrl!=null && menuDto.menu.menuUrl !=''}">
                    <div class="h80 lh80 C555 f30 adorn-color">
                        <a class="adorn-color" target="_blank"
                           href="${menuDto.menu.menuUrl}">${menuDto.menu.iconRemark}</a>
                    </div>
                    <a target="_blank" href="${menuDto.menu.menuUrl}"
                       class="f14 C000 lh26 p15 tc break-word fw200">${menuDto.menu.menuName}</a>
                </c:if>
...
<div class="BGFFF pt50 pb50">
    <div class="container p0">
        <div class="row p0">
            <div class="col-xs-8">
                <a class="adorn-color" target="_blank"
                   href="http://api.crap.cn/index.do#/article/detail?projectId=help&moduleId=155032424248009000006&type=ARTICLE&id=155037947655301000051">
            ...
            <div class="col-xs-4">
                <div class="tc f20 mb20 mt30 fw400">
                    <a class="adorn-color" target="_blank"
                       href="http://api.crap.cn/index.do#/article/detail?projectId=help&moduleId=155032424248009000006&type=ARTICLE&id=155037947655301000051">接口调试插件</a>
                </div>
                <div class="tc mt30 f12 C555 lh30">
        ...
        <table>
            <tr>
                ...
                <td class="bl1 pl50 mt50">
                    ...
                    <div class="tc">
                        <a class="mt20 btn btn-sm btn-default adorn-color w600 C999 b0"
                           href="index.do#/article/list?type=ARTICLE&status=2">
                            MORE
                        </a>
                    </div>
                </td>
...
<div class="m0 w lh26 s-nav-bg-color shadow fw200 pt20 pb20">
    <div class="container pt20 r5 r20 p5 h26 tr CFFF">
        ...
        <ul class="dis-in-tab p0 m0">
            <li class="dis-in-tab mr20 CFFF"><a target="_blank" class="CFFF" href="http://v39pay.com/">Boredou官网</a>
                <span class="bg_line"></span></li>
            <c:forEach items="${menuList}" var="menuDto" varStatus="id">
    ...
    <div class="container h26  p0 pl20 tc pb20 CFFF">
        ©<a href="http://v39pay.com/" target="_blank" class="CFFF">v39pay.com</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;版本号
        [V1.0.0]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <ul class="dis-in-tab p0 m0">
            <li class="dis-in-tab mr20">
                <a target="_blank" class="CFFF" href="/opendoc/resources/html/visitor/help.html">帮助文档</a>
            </li>
            <c:forEach items="${menuList}" var="menuDto" varStatus="id">
